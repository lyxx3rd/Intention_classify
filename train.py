...
model_path = "/data/gaohengyuan/law_classify/chinese-roberta-wwm-ext-large"
...
train_data_loader = DataLoader(DatasetClassify("./data/IMCS-DAC/train_list_data.json"), batch_size=64, shuffle=True,
                               collate_fn=collator_fn)
dev_data_loader = DataLoader(DatasetClassify("./data/IMCS-DAC/dev_list_data.json"), batch_size=64, shuffle=False,
                             collate_fn=collator_fn)
EPOCHS = 10
step = 0
accu_max = 0.0
